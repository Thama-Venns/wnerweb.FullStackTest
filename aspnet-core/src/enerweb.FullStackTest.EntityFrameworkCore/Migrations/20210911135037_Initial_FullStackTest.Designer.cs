...
{
    [DbContext(typeof(FullStackTestDbContext))]
    [Migration("20210911135037_Initial_FullStackTest")]
    partial class Initial_FullStackTest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("enerweb.FullStackTest.Models.Header", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("enerweb.FullStackTest.Models.OperatingDateRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OperatingDateRecords");
                });

            modelBuilder.Entity("enerweb.FullStackTest.Models.ProfileMeteringPeriod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<float?>("ReactiveEnergyLaggingQ1")
                        .HasColumnType("real");

                    b.Property<float?>("ReactiveEnergyLaggingQ3")
                        .HasColumnType("real");

                    b.Property<float?>("ReactiveEnergyLeadingQ2")
                        .HasColumnType("real");

                    b.Property<float?>("ReactiveEnergyLeadingQ4")
                        .HasColumnType("real");

                    b.Property<float?>("ReadingFlag")
                        .HasColumnType("real");
                    ...
                    b.ToTable("ProfileMeteringPeriods");
                });

            modelBuilder.Entity("enerweb.FullStackTest.Models.ServicePoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("enerweb.FullStackTest.Models.Trailer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("enerweb.FullStackTest.Models.OperatingDateRecord", b =>
                {
                    b.HasOne("enerweb.FullStackTest.Models.Header", "Header")
                        .WithMany()
