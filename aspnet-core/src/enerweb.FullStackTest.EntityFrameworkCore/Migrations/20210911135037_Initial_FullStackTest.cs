...
namespace enerweb.FullStackTest.Migrations
{
    public partial class Initial_FullStackTest : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecordType = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    UserID = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    FileType = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    CreationDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Unkonwn = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperatingDateRecords", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OperatingDateRecords_Headers_HeaderId",
                        column: x => x.HeaderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImportEnergy = table.Column<float>(type: "real", nullable: false),
                    ExportEnergy = table.Column<float>(type: "real", nullable: false),
                    ReactiveEnergyLeadingQ2 = table.Column<float>(type: "real", nullable: true),
                    ReactiveEnergyLeadingQ4 = table.Column<float>(type: "real", nullable: true),
                    ReactiveEnergyLaggingQ3 = table.Column<float>(type: "real", nullable: true),
                    ReactiveEnergyLaggingQ1 = table.Column<float>(type: "real", nullable: true),
                    ReadingFlag = table.Column<float>(type: "real", nullable: true),
                    HeaderId = table.Column<int>(type: "int", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfileMeteringPeriods", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfileMeteringPeriods_Headers_HeaderId",
                        column: x => x.HeaderId,
                        principalTable: "Headers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RecordType = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    MeterID = table.Column<string>(type: "nvarchar(14)", maxLength: 14, nullable: true),
                    MeterSerialNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    HeaderId = table.Column<int>(type: "int", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicePoints_Headers_HeaderId",
                        column: x => x.HeaderId,
                        principalTable: "Headers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trailers_Headers_HeaderId",
                        column: x => x.HeaderId,
                        principalTable: "Headers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperatingDateRecords_HeaderId",
                table: "OperatingDateRecords",
                column: "HeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfileMeteringPeriods_HeaderId",
                table: "ProfileMeteringPeriods",
                column: "HeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicePoints_HeaderId",
                table: "ServicePoints",
                column: "HeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_Trailers_HeaderId",
                table: "Trailers",
                column: "HeaderId");
        }
